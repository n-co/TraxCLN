...
probes_path = "../TraxInputData/Probes/"
bottles_path = "../TraxInputData/Bottles/"
...
class Bottle:
    def __init__(self, id, brand_code, brand_label, form_factor_label, mask, object_label, patch_id, patch_url,
        ...
        self.mask = json.loads(mask)  # TODO: convert to json
    ...
    def get_frame(self):
        fr = json.loads(self.mask)
        return fr

    def get_cropped_image(self):
        image_path = probes_path + self.probe_id + ".jpg"
...
def import_data():
    with open(csv_path, 'r') as f:
        ...
        for row in reader:
            ...
            ocv.imwrite(bottles_path + bottle.patch_url, cropped)
